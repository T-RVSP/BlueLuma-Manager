...
namespace GLMUpdater
{
	class Updater
	{
		...
		private readonly string downloadURL = "https://github.com/T-RVSP/BlueLuma-Manager/releases/download/v{0}/BlueLuma.Manager.zip";
		...
		public async Task IsUpdated()
		{
			...
			if (currentVersion.CompareTo(latestVersion) < 0)
			{
				...
				foreach (Process process in Process.GetProcessesByName("BlueLuma Manager"))
				{
				...
				while (Process.GetProcessesByName("BlueLuma Manager").Length > 0)
				{
